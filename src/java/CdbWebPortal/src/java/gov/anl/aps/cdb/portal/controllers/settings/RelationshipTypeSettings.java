 ...
 * @author djarosz
 */
public class RelationshipTypeSettings extends SettingsBase<RelationshipTypeController>{

    public RelationshipTypeSettings(RelationshipTypeController parentController) {

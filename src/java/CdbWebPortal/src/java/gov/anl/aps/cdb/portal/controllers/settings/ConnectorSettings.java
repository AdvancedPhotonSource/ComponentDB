...
import gov.anl.aps.cdb.portal.controllers.ConnectorController;
 ...
 * @author djarosz
 */
public class ConnectorSettings extends SettingsBase<ConnectorController> {

    public ConnectorSettings(ConnectorController parentController) {

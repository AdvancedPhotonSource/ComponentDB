...
import gov.anl.aps.cdb.portal.controllers.LogLevelController;
 ...
 * @author djarosz
 */
public class LogLevelSettings extends SettingsBase<LogLevelController> {

    public LogLevelSettings(LogLevelController parentController) {

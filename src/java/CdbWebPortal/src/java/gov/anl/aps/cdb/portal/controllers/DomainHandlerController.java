...
@SessionScoped
public class DomainHandlerController implements Serializable {

    private DomainHandler current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cdb.portal.model.db.beans.DomainHandlerFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public DomainHandlerController() {
    }

    public DomainHandler getSelected() {
        if (current == null) {
            current = new DomainHandler();
            selectedItemIndex = -1;
        }
        return current;
    }

    private DomainHandlerFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (DomainHandler) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DomainHandlerCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DomainHandlerUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DomainHandlerDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public DomainHandler getDomainHandler(java.lang.Integer id) {

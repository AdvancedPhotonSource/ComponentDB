...
@SessionScoped
public class RelationshipTypeController implements Serializable {

    private RelationshipType current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cdb.portal.model.db.beans.RelationshipTypeFacade ejbFacade;
    ...
    public RelationshipType getSelected() {
        if (current == null) {
            current = new RelationshipType();
            selectedItemIndex = -1;
        }
        return current;
    }

    private RelationshipTypeFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (RelationshipType) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("RelationshipTypeCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("RelationshipTypeUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("RelationshipTypeDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public RelationshipType getRelationshipType(java.lang.Integer id) {
    ...
    public static class RelationshipTypeControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getRelationshipType(getKey(value));
        }

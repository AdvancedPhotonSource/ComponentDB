...
public class PropertyTypeController implements Serializable
{
    ...
    private PropertyType current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cdb.portal.model.beans.PropertyTypeFacade ejbFacade;
    ...
    public PropertyType getSelected() {
        if (current == null) {
            current = new PropertyType();
            selectedItemIndex = -1;
        }
        return current;
    }

    private PropertyTypeFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (PropertyType) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("PropertyTypeCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("PropertyTypeUpdated"));
            return "View";
        }
        catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("PropertyTypeDeleted"));
        }
        catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    ...
    public PropertyType getPropertyType(java.lang.Integer id) {
    ...
    public static class PropertyTypeControllerConverter implements Converter
    {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPropertyType(getKey(value));
        }

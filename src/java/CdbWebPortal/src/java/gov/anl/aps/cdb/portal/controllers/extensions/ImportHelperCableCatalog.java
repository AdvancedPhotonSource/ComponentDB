...
public class ImportHelperCableCatalog extends ImportHelperBase<ItemDomainCableCatalog, ItemDomainCableCatalogController> {
    ...
    protected void createColumnModels_() {
        ...
        columns.add(new IdRefColumnModel("Manufacturer", "manufacturer", "setManufacturerSource", false, "Manufacturer or vendor, e.g., CommScope", SourceController.getInstance(), Source.class));
        ...
        columns.add(new IdRefColumnModel("Owner", "team", "setTeam", false, "Numeric ID of CDB technical system.", ItemCategoryController.getInstance(), ItemCategory.class));
    }

...
public class ImportHelperCableCatalog extends ImportHelperBase {
    ...
    protected void createColumnModels_() {
        ...
        columns.add(new StringColumnModel("Manufacturer", "manufacturer", "setManufacturer", false, "CommScope"));
        ...
        columns.add(new StringColumnModel("Category Id", "team", "setTeam", true, "26"));
    }

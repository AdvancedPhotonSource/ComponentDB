 ...
 * @author djarosz
 */
public class PropertyTypeCategorySettings extends CdbEntitySettingsBase<PropertyTypeCategoryController> {
    ...
    public PropertyTypeCategorySettings(PropertyTypeCategoryController parentController) {

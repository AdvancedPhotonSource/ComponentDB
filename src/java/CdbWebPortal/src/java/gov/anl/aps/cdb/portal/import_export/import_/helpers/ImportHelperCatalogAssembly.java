...
public class ImportHelperCatalogAssembly extends ImportHelperBase<ItemElement, ItemElementController> {
    ...
    private static final String ROW_KEY_PARENT_ITEM = "importParentItem";

    protected List<ColumnSpec> getColumnSpecs() {
        
        List<ColumnSpec> specs = new ArrayList<>();
        
        specs.add(new IdOrNameRefColumnSpec("Catalog Item", ROW_KEY_PARENT_ITEM, "setImportParentItem", true, "ID or name of parent catalog item. Name must be unique and prefixed with '#'.", ItemDomainCatalogController.getInstance(), Item.class, null));        

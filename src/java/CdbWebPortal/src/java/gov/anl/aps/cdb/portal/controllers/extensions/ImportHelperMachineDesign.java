...
public class ImportHelperMachineDesign extends ImportHelperBase<ItemDomainMachineDesign, ItemDomainMachineDesignController> {
    ...
    protected void createColumnModels_() {
        ...
        columns.add(new ImportHelperBase.StringColumnModel("Path", "importPath", "setImportPath", true, "Path to new machine design item within container (/ separated).", 700));
        ...
        columns.add(new ImportHelperBase.IdRefColumnModel("Assigned Item Id", "assignedItemString", "setAssignedItemId", false, "Numeric ID of assigned catalog or inventory item.", 0, ItemDomainCatalogController.getInstance()));
        columns.add(new ImportHelperBase.IdRefColumnModel("Location Id", "locationString", "setLocationId", false, "Numeric ID of CDB location item.", 0, ItemDomainLocationController.getInstance()));

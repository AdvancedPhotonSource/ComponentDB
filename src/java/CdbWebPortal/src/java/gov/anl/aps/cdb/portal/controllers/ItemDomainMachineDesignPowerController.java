...
@SessionScoped
public class ItemDomainMachineDesignPowerController extends ItemDomainMachineDesignRelationshipBaseController<ItemDomainMachineDesignPowerControllerUtility> {

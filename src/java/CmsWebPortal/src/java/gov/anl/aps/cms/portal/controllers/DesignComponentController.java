...
import gov.anl.aps.cms.portal.model.entities.DesignComponent;
import gov.anl.aps.cms.portal.controllers.util.JsfUtil;
import gov.anl.aps.cms.portal.controllers.util.PaginationHelper;
import gov.anl.aps.cms.portal.model.beans.DesignComponentFacade;
...
public class DesignComponentController implements Serializable {
    ...
    @EJB
    private gov.anl.aps.cms.portal.model.beans.DesignComponentFacade ejbFacade;
    ...
    public String prepareView() {
        current = (DesignComponent) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DesignComponentCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DesignComponentUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("DesignComponentDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public DesignComponent getDesignComponent(java.lang.Integer id) {
    ...
    public static class DesignComponentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DesignComponent) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DesignComponent.class.getName());
            }
        }

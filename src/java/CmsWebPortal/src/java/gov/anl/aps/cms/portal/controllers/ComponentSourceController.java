...
@SessionScoped
public class ComponentSourceController implements Serializable {

    private ComponentSource current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cms.portal.model.beans.ComponentSourceFacade ejbFacade;
    ...
    public ComponentSource getSelected() {
        if (current == null) {
            current = new ComponentSource();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ComponentSourceFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ComponentSource) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentSourceCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentSourceUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentSourceDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ComponentSource getComponentSource(java.lang.Integer id) {
    ...
    public static class ComponentSourceControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getComponentSource(getKey(value));
        }

...
@SessionScoped
public class CollectionComponentController implements Serializable {

    private CollectionComponent current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cms.portal.model.beans.CollectionComponentFacade ejbFacade;
    ...
    public CollectionComponent getSelected() {
        if (current == null) {
            current = new CollectionComponent();
            selectedItemIndex = -1;
        }
        return current;
    }

    private CollectionComponentFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (CollectionComponent) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("CollectionComponentCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("CollectionComponentUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("CollectionComponentDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public CollectionComponent getCollectionComponent(java.lang.Integer id) {
    ...
    public static class CollectionComponentControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getCollectionComponent(getKey(value));
        }

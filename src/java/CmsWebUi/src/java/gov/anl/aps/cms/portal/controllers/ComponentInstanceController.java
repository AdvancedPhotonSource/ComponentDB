...
import gov.anl.aps.cms.portal.model.entities.ComponentInstance;
import gov.anl.aps.cms.portal.controllers.util.JsfUtil;
import gov.anl.aps.cms.portal.controllers.util.PaginationHelper;
import gov.anl.aps.cms.portal.model.beans.ComponentInstanceFacade;
...
public class ComponentInstanceController implements Serializable {
    ...
    @EJB
    private gov.anl.aps.cms.portal.model.beans.ComponentInstanceFacade ejbFacade;
    ...
    public static class ComponentInstanceControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ComponentInstance) {
                ...
                return getStringKey(o.getComponentInstanceId());
            } else {

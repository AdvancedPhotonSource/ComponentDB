...
@SessionScoped
public class ComponentStateController implements Serializable {

    private ComponentState current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cms.portal.model.beans.ComponentStateFacade ejbFacade;
    ...
    public ComponentState getSelected() {
        if (current == null) {
            current = new ComponentState();
            selectedItemIndex = -1;
        }
        return current;
    }

    private ComponentStateFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ComponentState) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentStateCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentStateUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ComponentStateDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ComponentState getComponentState(java.lang.Integer id) {
    ...
    public static class ComponentStateControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getComponentState(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ComponentState) {
                ...
                return getStringKey(o.getComponentStateId());
            } else {

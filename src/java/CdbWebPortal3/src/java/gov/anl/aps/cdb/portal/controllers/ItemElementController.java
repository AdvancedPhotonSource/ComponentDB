...
@SessionScoped
public class ItemElementController implements Serializable {

    private ItemElement current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cdb.portal.model.db.beans.ItemElementFacade ejbFacade;
    ...
    public ItemElement getSelected() {
        if (current == null) {
    ...
    private ItemElementFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (ItemElement) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ItemElementCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ItemElementUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("ItemElementDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public ItemElement getItemElement(java.lang.Integer id) {
    ...
    public static class ItemElementControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getItemElement(getKey(value));
        }

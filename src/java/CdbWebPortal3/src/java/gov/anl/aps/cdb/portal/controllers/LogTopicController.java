...
@SessionScoped
public class LogTopicController implements Serializable {

    private LogTopic current;
    private DataModel items = null;
    @EJB
    private gov.anl.aps.cdb.portal.model.db.beans.LogTopicFacade ejbFacade;
    ...
    public LogTopic getSelected() {
        if (current == null) {
            current = new LogTopic();
            selectedItemIndex = -1;
        }
        return current;
    }

    private LogTopicFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (LogTopic) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("LogTopicCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("LogTopicUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources").getString("LogTopicDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public LogTopic getLogTopic(java.lang.Integer id) {
    ...
    public static class LogTopicControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getLogTopic(getKey(value));
        }

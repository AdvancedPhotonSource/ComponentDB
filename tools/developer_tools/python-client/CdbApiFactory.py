...
class CdbApiFactory:
    ...
    def __init__(self, cdbUrl):
        ...
        self.iocItemApi = IOCItemsApi(api_client=self.apiClient)
        ...
        self.componentCatalogItemApi = ComponentCatalogItemsApi(
            api_client=self.apiClient
        )
        self.componentInventoryItemApi = ComponentInventoryItemsApi(
            api_client=self.apiClient
        )
    ...
    def getIOCItemApi(self) -> IOCItemsApi:
        return self.iocItemApi

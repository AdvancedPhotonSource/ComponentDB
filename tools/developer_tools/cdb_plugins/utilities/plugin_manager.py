...
CDB_PLUGIN_CONFIGURATION_DIR = '%s/etc/plugins' % CDB_INSTALL_DIRECTORY

JAVA_PLUGIN_REGISTRAR_FILE_NAME = 'PluginRegistrar.java'

class PluginManager():
    def __init__(self, use_default_storage_directory=False):
        ...
        self.__load_plugins()
        self.java_parser = PluginJavaParser(CDB_PLUGIN_CONFIGURATION_DIR)
        self.python_parser = PluginPythonParser(CDB_PLUGIN_CONFIGURATION_DIR)
    ...
    def __update_autogenerated_files(self):
        ...
        if not os.path.exists(CDB_PLUGIN_CONFIGURATION_DIR):
            os.makedirs(CDB_PLUGIN_CONFIGURATION_DIR)

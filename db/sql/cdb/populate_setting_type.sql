...
VALUES
	...
	('Search.List.Display.ComponentTypes','Display search result for component types.', 'false'),
	('Search.List.Display.ComponentTypeCategories','Display search result for component type categories.', 'false'),
	('Search.List.Display.NumberOfItemsPerPage','Display specified number of items per page.', '25'),
	('Search.List.Display.PropertyTypes','Display search result for property types.', 'false'),
	('Search.List.Display.PropertyTypeCategories','Display search result for property type categories.', 'false'),
	('Search.List.Display.Sources','Display search result for sources.', 'false'),
	('Search.List.Display.Users','Display search result for users.', 'false'),
	('Search.List.Display.UserGroups','Display search result for user groups.', 'false'),

...
('AssemblyComponent.List.Display.Description','Display assembly component description.','true'),
('AssemblyComponent.List.Display.FlatTableView','Display flat table view for assembly component list.','false'),
('AssemblyComponent.List.Display.Id','Display assembly component id.','false'),
('AssemblyComponent.List.Display.NumberOfItemsPerPage','Display specified number of items per page.','25'),
('AssemblyComponent.List.Display.SortOrder','Display assembly component sort order.','true'),
('AssemblyComponent.List.FilterBy.Description','Filter for assembly components by description.',NULL),
('AssemblyComponent.List.FilterBy.Name','Filter for assembly components by name.',NULL),
('AssemblyComponent.List.FilterBy.SortOrder','Filter for assembly components by sort order.',NULL),
...
('ComponentInstanceLocationHistory.List.Display.EnteredOnDateTime','Display location entered on date/time.','true'),
('ComponentInstanceLocationHistory.List.Display.EnteredByUser','Display location entered by user.','true'),
('ComponentInstanceLocationHistory.List.Display.Id','Display entry id.','false'),
('ComponentInstanceLocationHistory.List.Display.LocationDetails','Display location details.','true'),
('ComponentInstanceLocationHistory.List.Display.NumberOfItemsPerPage','Display specified number of items per page.','25'),
('ComponentInstanceLocationHistory.List.FilterBy.EnteredOnDateTime','Filter for location entered on date/time.',NULL),
('ComponentInstanceLocationHistory.List.FilterBy.EnteredByUser','Filter for location entered by user.',NULL),
('ComponentInstanceLocationHistory.List.FilterBy.Location','Filter for location name.',NULL),
('ComponentInstanceLocationHistory.List.FilterBy.LocationDetails','Filter location details.',NULL),
...
('Search.Display.AssemblyComponents','Display search result for assembly components.','true'),

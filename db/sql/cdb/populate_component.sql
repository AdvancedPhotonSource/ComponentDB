...
(187,'Multiplet Plinth (Type B)','140\" long plinth for multiplet',119,427),
(191,'Schroff MicroTCA Chassis (chassis only)','Model 11850-026',7,440),
...
(193,'NAT-MCH-PHYS (MicroTCA Carrier Hub) ','NAT-MCH Gen 3 with PCIe Option',10,442),
...
(196,'AMC-V7-2C6678 MicroTCA DSP/FPGA','AMC card, Xilinx Virtex 7, 2 x 1.25GHz TMS320C6678 DSPs',43,446),
(197,'Libera Brilliance+ (APS Model)','Customized Unit for APS',125,453),
(198,'Libera Brilliance+ (original)','Electron Beam Position Processor\r\n',125,456),
(199,'EPICS IOC code','',54,468),
(200,'DSP code','',54,469),
(201,'FPGA code','',54,470),
(202,'Fiber-optic cable','',34,475),
(203,'Connector','',9,476),
(204,'VME-EVG-230','Event Generator (Gen 2)',56,480),
...
(213,'M1 dipole pre-prototype','First prototype magnet (from Fermilab)',80,536),
(214,'Samsung Galaxy Tab 10.5','',121,537),
(215,'PRL-760C4','AC Adapter for PRL-* devices\r\nÂ±8.5 V/1.8 A, +17 V/200 mA, 120 VAC adapter w/4 modular plugs',49,539),
(216,'PRL-424LV','1:4 LVDS Fanout Buffer',108,540),
(217,'Generic: Data Logging System','',129,554),
(218,'Generic: Measurement System','',128,555),
(219,'SYS9100 Magnet Power Supply','',49,556),
(220,'E5810A GPIB/Ethernet Gateway','',130,560),
(221,'3458A DVM','8.5 Digit DVM',48,561),
(222,'DE304 RS-232/Ethernet Gateway','',130,562),
(223,'DS200CLSA DCCT','200A DCCT',131,566),
(226,'DCCT Burden Resister Chassis','Temperature Controlled Burden Resister Assembly; Includes power supply.',89,579),
(227,'Quad Doublet Plinth (Type A)','59\" long plinth for Quad Doublet',119,581),
(228,'FODO Plinth (Type C)','255.50\" long plinth for FODO',119,582),
(229,'M1 Magnetic Measurement Test Table','',120,590),
(230,'E5810B GPIB/Ethernet Gateway','',130,593),
(231,'EPSC','Ethernet Power Supply Controller',18,595),
(232,'KH523','Precision DC Source/Calibrator',9,597),
(233,'VPR221Z','Ultra High Precision Z-Foil Power Resistor',85,602),
(236,'Moxa 6450','4-port ethernet to serial converter',109,608),
(245,'u221020202-104000.drw','Drawing for part u221020202-104000',84,619),
(250,'DMM Sextupole Coil','Sextupole Coil Data',84,624);

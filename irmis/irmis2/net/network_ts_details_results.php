<?php 
    /* Network Terminal Server Search Results Page
     * Display terminal server details search results
     */
...
<html>
<head>
<title>Terminal Server Details Search Results</title>
...
<?php  
    ...
    include('i_network_ts_results.php'); 
	include('i_network_ts_details_results.php');
?>
</body>
</html>

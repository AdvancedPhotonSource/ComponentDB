...
//  session.
if (!isset ($_SESSION['SpareList'])) {
  $initializedSpareList = new SpareList();
  $_SESSION['SpareList'] = $initializedSpareList;
}
...
// make sure we have initial blank value for spares missing checkbox
unset($_SESSION['noSpare']);

// make sure we have initial blank value for critical component checkbox

 ...
 */
  ...
  class DBQueryBuilder {
    ...
    /*
	 * addDistinct() will add the keyword 'distinct' after the 'select' keyword.
	 * This will provide the return of only unique records in a record set
	 * derived from a given query.
	 */
	function addDistinct($bool) {
	    $this->distinctKeyword = $bool;
	}

    /*
     * This can be used to suppress the trailing semicolon in the SQL
     * returned by getQueryString() function.
     */
    function appendSemicolon($bool) {
        $this->appendSemicolon = $bool;
    }

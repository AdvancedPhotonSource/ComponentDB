<form action="../power/action_power_search.php" method="POST">
<div class="searchCriteria">
  <table width="98%"  border="0" align="right" cellpadding="2" cellspacing="0">
	...
	<tr>
      <td class="titleheading" colspan="2">AC Power Info<br />&nbsp;Search Criteria</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr>
      <td><select name="switchgearConstraint" class="pulldown">
		 <? if ($_SESSION['switchgearConstraint']) {
		       echo '<option value="'.$_SESSION['switchgearConstraint'].'" selected>'.$_SESSION['switchgearConstraint'].'</option>\n';
			   echo '<option value="">---- All ----</option>\n';
	        ...
	        $result = $_SESSION['switchgearList'];
            //logEntry('debug',"here's my roomList session var ".print_r($result,true)); 
			$switchgearArray = $result->getArray();
			foreach ($switchgearArray as $switchgearEntity) {
	        echo '<option value="'.$switchgearEntity->getLogicalDesc().'">'.$switchgearEntity->getLogicalDesc().'</option>\n';
			}?>
			</select></td>
    </tr>
 ...
 -->	<tr>
	...
	<tr>
      <td><span class="buttonposition"><input type="submit" value="Search"  class="buttons" style="background:#ffff00">
	      <input type="submit" name="powerReset" value="Reset"  class="buttons" style="background:#ffff00"></span></td>
    </tr>
	<tr>
      <td>&nbsp;</td>
    </tr>	
  ...
  <div id="help">
  <table>
  <tr><td><a class="hyper" href="../top/wd_help.php#ac" target="_blank"><b>Web Desktop Help</b></a></td></tr>
  </table>
  </div>

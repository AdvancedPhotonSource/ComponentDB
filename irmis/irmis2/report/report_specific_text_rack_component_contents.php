<?php
  ...
  */
   ...
   foreach($rackCCEntities as $rackCCEntity)
   {
      ...
      //Write the IOC Name------------------------------------------------------------------
      fwrite($fp, $rackCCEntity->getcomponentTypeName()."\t\t");

      //Write the System--------------------------------------------------------------------
      fwrite($fp, $rackCCEntity->getcomponentInstanceName()."\t");
	  
	  //Write the Locator-------------------------------------------------------------------
	  fwrite($fp, $rackCCEntity->getLogicalDesc()."\t");

      //Write the Description---------------------------------------------------------------
      fwrite($fp, $rackCCEntity->getDescription()."\t");

      //Write the Cognizant Developer-------------------------------------------------------
      fwrite($fp, $rackCCEntity->getManufacturer()."\t");

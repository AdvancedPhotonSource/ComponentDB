...
insert into base_component_type values (1, 'Site');
insert into base_component_type values (2, 'Network');
...
insert into component_type values (1, 'Network', 'Controls network. Root of controls hierarcy.', null, null, 0, 0);
insert into component_type_if values (1, 1, 0, 1, 0, 1, 129, 0, 0);
insert into component_type_status values (1, 1, 0, 0, null, 1, 0, 0);

insert into component_type values (2, 'Site', 'Overall facility. Root of housing hierarcy.', 1, 1, 0, 0);
insert into component_type_if values (2, 2, 0, 1, 0, 2, 51, 0, 0);
insert into component_type_status values (2, 2, 0, 0, null, 1, 0, 0);

insert into component_type values (3, 'Utility', 'Power utility. Root of power hierarcy.', 1, 1, 0, 0);
insert into component_type_if values (3, 3, 0, 1, 0, 3, 114, 0, 0);
insert into component_type_status values (3, 3, 0, 0, null, 1, 0, 0);

insert into component_type values (4, 'Building', 'On site building', 1, 1, 0, 0);
...
insert into component_type values (5, 'Room', 'Room', 1, 1, 0, 0);
...
insert into component_type values (6, 'Rack', '19" Equipment Rack', 1, 1, 0, 0);
...
insert into component_type values (7, 'Switch Gear', 'AC Switch Gear', 8, 1, 0, 0);
...
insert into component_type values (8, 'Circuit Breaker', 'AC Circuit Breaker', 8, 1, 0, 0);
...
insert into component_type values (9, 'AC Panel', 'AC Distribution/Breaker Panel', 18, 1, 0, 0);
...
insert into component_type values (10, 'AC Circuit (120V)', '120VAC Circuit', 5, 1, 0, 0);
...
insert into component_type values (11, '120VAC Power Strip/Outlet', '120VAC Power Strip/Circuit', 5, 1, 0, 0);
...
insert into component_type values (12, 'VME Chassis-Mupac', '20 Slot VME Chassis - 9U', 2, 62, 0, 0);
...
insert into component_type values (13, 'MVME 2100', 'MVME 2100', 3, 60, 0, 0);
...
insert into component_type values (14, 'VME Power Supply - Mupac', 'Integrated PS w fan for MUPAC', 5, 112, 0, 0);

...
/**
 * IRMIS component history repair dialox box (operational state).
 */
public class ComponentHistoryRepairDialog extends DialogBox {

    static final String title = "Component Repaired";
    ...
    public ComponentHistoryRepairDialog(ComponentHistoryController controller) {
        ...
        // prompt for description of repair (comment)
        Label repairDescLabel = new Label("Enter description of repair:");
        ...
        Label testLabel = new Label("Enter test conducted (if any):");
    ...
    public boolean okAction(ActionEvent e) {
        ...
        controller.actionNewRepairHistory(eventDate, comment, test);
        return true;
    }

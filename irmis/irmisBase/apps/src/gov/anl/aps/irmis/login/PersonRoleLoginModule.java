...
/**
 * This LoginModule hardcodes a successful authentication,
 * expecting only a username from the CallbackHandler.
 * It then proceeds to retrieve allowed roles (authorization)
 * from the person and role tables in the relational database.
 * 
 */
public class PersonRoleLoginModule implements LoginModule {
    ...
    /**
     * Hardcode a successful authentication. This login module only authorizes.
     *
    ...
    public boolean commit() throws LoginException {
        if (succeeded == false) {
            ...
            if (debug) {
                System.out.println("\t\t[PersonRoleLoginModule] " +

...
/**
 * IRMIS component history tested dialox box (operational state).
 */
public class ComponentHistoryTestedDialog extends DialogBox {

    static final String title = "Component Tested";
    ...
    public ComponentHistoryTestedDialog(ComponentHistoryController controller) {
        ...
        // prompt for description of test (comment)
        Label repairDescLabel = new Label("Enter description of test work:");

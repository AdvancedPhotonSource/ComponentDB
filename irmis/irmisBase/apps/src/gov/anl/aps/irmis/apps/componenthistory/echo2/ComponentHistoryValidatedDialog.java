...
/**
 * IRMIS component history validated dialox box (procedure category).
 */
public class ComponentHistoryValidatedDialog extends DialogBox {

    static final String title = "Component Validated";
    ...
    public ComponentHistoryValidatedDialog(ComponentHistoryController controller) {
        ...
        // prompt for description of validateion (comment)
        Label repairDescLabel = new Label("Enter description of validation work:");
        ...
        // prompt for test used (if any)
        Label testLabel = new Label("Enter validation procedure # (if any):");
    ...
    public boolean okAction(ActionEvent e) {
        ...
        controller.actionNewValidationHistory(eventDate, comment, test);
        return true;
    }

...
CDB_RUN_DIR=${CDB_RUN_DIR:=$CDB_ROOT_DIR/..}
CDB_ETC_DIR=${CDB_RUN_DIR}/etc
...
CDB_WEB_SERVICE_LOG_FILE=${CDB_RUN_DIR}/var/log/$CDB_WEB_SERVICE_DAEMON.$CDB_DB_NAME.log
CDB_WEB_SERVICE_INIT_CMD=${CDB_ROOT_DIR}/etc/init.d/$CDB_WEB_SERVICE_DAEMON

echo "CDB run directory: $CDB_RUN_DIR"

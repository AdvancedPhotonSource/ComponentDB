...
#
# Script used for configuring CMS webapp
...
CMS_DB_PORT=${CMS_DB_PORT:=3306}
CMS_DB_USER=${CMS_DB_USER:=cms}
CMS_DB_PASSWORD=${CMS_DB_PASSWORD:=cms}
...
echo "Creating JDBC connection pool $CMS_DB_POOL"
...
echo "Creating JDBC resource $CMS_DATA_SOURCE"

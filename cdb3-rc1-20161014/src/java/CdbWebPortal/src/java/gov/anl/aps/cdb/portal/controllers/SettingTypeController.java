...
public class SettingTypeController implements Serializable {
    ...
    public SettingType getSelected() {
        if (current == null) {
            current = new SettingType();
            selectedItemIndex = -1;
        }
        return current;
    }

    private SettingTypeFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (SettingType) getItems().getRowData();
    ...
    public SettingType getSettingType(java.lang.Integer id) {
